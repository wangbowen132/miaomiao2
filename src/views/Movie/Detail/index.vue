    ...
    <Header title="影片详情">
		...
		<div v-else id="content" class="contentDetail">
			<div class="detail_list">
				<div class="detail_list_bg" :style="{'background-image': 'url(' + datalist.poster + ')'}"></div>
...
.detail_list .detail_list_bg{ width:100%; height:100%; background: 0 40%; filter: blur(6px); background-size:cover; position: absolute; left: 0; top: 0;}
